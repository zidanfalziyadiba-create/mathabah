...
const services = {
  ...
  "/services/stone-marble": {
    title: "أعمال الحجر والرخام والكسوات في السعودية | مؤسسة مثابة",
    shortTitle: "الحجر والرخام",
    description: "تصميم وتنفيذ أعمال الحجر والرخام والكسوات الداخلية والخارجية للمنازل والمكاتب والمشاريع التجارية، مع عناية بالتفصيل والملمس والتشطيب.",
    image: "/mathabah-architectural-texture_423c537d_e9b373de.webp",
    points: ["كسوات جدران الحجر والرخام", "أسطح وكونترات وتفاصيل داخلية", "مداخل وواجهات وكسوات خارجية", "اختيار الخامة والتشطيب المناسب"],
  },
} as const;

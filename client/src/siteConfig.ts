...
export const siteConfig = {
  ...
  marquee: {
    ...
    text: "حلول زجاجية ومعمارية متقدمة | تنفيذ بدقة واحترافية | خصومات خاصة للمشاريع الجديدة"
  },
  ...
  promotionalPopup: {
    ...
    title: "عرض خاص على أعمال الزجاج والمعمار",
    description: "احصل على خصم استثنائي عند التعاقد على واجهات المباني والتصميم الداخلي هذا الأسبوع.",
